...
iteration: 1
max_iterations: 0
started_at: "2026-01-16T13:24:45Z"
feature_name: "plan the above feature"
feature_slug: "plan-the-above-feature"
output_dir: "docs/specs"
spec_path: "docs/specs/plan-the-above-feature.md"
...
- **Feature:** plan the above feature
- **Draft File:** .claude/lisa-draft.md (update this as you gather information)
- **Final Spec:** docs/specs/plan-the-above-feature.md (write here when user says done)
- **Started:** 2026-01-16
...
Start by asking your first non-obvious question about "plan the above feature" using the AskUserQuestion tool. Remember: EVERY question must use AskUserQuestion - plain text questions will not work!
